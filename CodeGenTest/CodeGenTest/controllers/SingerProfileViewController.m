...
@interface SingerProfileViewController()
@end

@implementation SingerProfileViewController
...
- (void)loadView
{
    ...
    UIImage *image = [UIImage imageNamed:@"singer_profile.png"];
    ...
    self.view = view;
    NSLog(@"SingerProfileViewController.loadView");
}
