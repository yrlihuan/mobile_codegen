...
- (void)loadView
{
    ...
    UIImage *image = [UIImage imageNamed:@"message_thread.png"];
    ...
    [button setTitle:@"launch message reply" forState:UIControlStateNormal];
    [button addTarget:self action:@selector(handleLaunchMessageReply:) forControlEvents:UIControlEventTouchUpInside];
    [view addSubview:button];

    view.backgroundColor = [UIColor whiteColor];

    self.view = view;
    NSLog(@"MessageThreadViewController.loadView");
}
...
// Event Handlers
// --------------------------------------
- (IBAction)handleLaunchMessageReply:(id)sender
{
    [[HGAppDelegate getInstance] handleCommandWithData:kLaunchMessageReply data:nil];
}
