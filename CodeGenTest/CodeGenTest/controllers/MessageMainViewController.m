...
- (void)loadView
{
    ...
    UIImage *image = [UIImage imageNamed:@"message_main.png"];
    ...
    [button setTitle:@"launch message list" forState:UIControlStateNormal];
    [button addTarget:self action:@selector(handleLaunchMessageList:) forControlEvents:UIControlEventTouchUpInside];
    [view addSubview:button];

    view.backgroundColor = [UIColor whiteColor];

    self.view = view;
    NSLog(@"MessageMainViewController.loadView");
}
...
// Event Handlers
// --------------------------------------
- (IBAction)handleLaunchMessageList:(id)sender
{
    [[HGAppDelegate getInstance] handleCommandWithData:kLaunchMessageList data:nil];
}
