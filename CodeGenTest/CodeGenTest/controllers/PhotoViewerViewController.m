...
- (void)loadView
{
    ...
    UIImage *image = [UIImage imageNamed:@"photo_viewer.png"];
    ...
    [button setTitle:@"launch singer profile" forState:UIControlStateNormal];
    [button addTarget:self action:@selector(handleLaunchSingerProfile:) forControlEvents:UIControlEventTouchUpInside];
    [view addSubview:button];

    view.backgroundColor = [UIColor whiteColor];

    self.view = view;
    NSLog(@"PhotoViewerViewController.loadView");
}
...
{
    [[HGAppDelegate getInstance] handleCommandWithData:kLaunchSingerProfile data:nil];
}
