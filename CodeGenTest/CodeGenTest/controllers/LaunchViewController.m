...
- (void)loadView
{
    ...
    [button setTitle:@"launch countdown finished" forState:UIControlStateNormal];
    [button addTarget:self action:@selector(handleLaunchCountdownFinished:) forControlEvents:UIControlEventTouchUpInside];
    [view addSubview:button];

    view.backgroundColor = [UIColor whiteColor];

    self.view = view;
    NSLog(@"LaunchViewController.loadView");
}
...
// Event Handlers
// --------------------------------------
- (IBAction)handleLaunchCountdownFinished:(id)sender
{
    [[HGAppDelegate getInstance] handleCommandWithData:kLaunchCountdownFinished data:nil];
}
