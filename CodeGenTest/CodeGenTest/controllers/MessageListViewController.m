...
- (void)loadView
{
    ...
    UIImage *image = [UIImage imageNamed:@"message_list.png"];
    ...
    [button setTitle:@"launch message thread" forState:UIControlStateNormal];
    [button addTarget:self action:@selector(handleLaunchMessageThread:) forControlEvents:UIControlEventTouchUpInside];
    [view addSubview:button];

    view.backgroundColor = [UIColor whiteColor];

    self.view = view;
    NSLog(@"MessageListViewController.loadView");
}
...
// Event Handlers
// --------------------------------------
- (IBAction)handleLaunchMessageThread:(id)sender
{
    [[HGAppDelegate getInstance] handleCommandWithData:kLaunchMessageThread data:nil];
}
